    ...
    Functions: {
      ...
      st_assvg: {
        Args:
          ...
          | { rel?: number; maxdecimaldigits?: number; geom: unknown }
        Returns: string
      }
      st_astext: {
        Args: { "": string } | { "": unknown } | { "": unknown }
      ...
      st_curvetoline: {
        Args: { tol?: number; flags?: number; toltype?: number; geom: unknown }
        Returns: unknown
      }
      ...
      st_hexagon: {
        Args: { cell_i: number; origin?: unknown; cell_j: number; size: number }
        Returns: unknown
      }
      st_hexagongrid: {
