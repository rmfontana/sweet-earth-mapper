--
-- Migration to correctly join to the locations table for filtering by location_name
--
...
BEGIN
  ...
  WITH filtered_submissions AS (
    ...
    -- Add the join to the locations table here to enable filtering by location_name
    ...
    WHERE s.verified = TRUE
      ...
      -- Add a new filter to use the location_name from the front end
...
--
-- Updated function for location leaderboard
--
