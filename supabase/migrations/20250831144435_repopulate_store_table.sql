-- This migration populates the `stores` table with the provided data.
-- The `id` will be automatically generated by the database.
-- The `location_id` is intentionally left as NULL for now, and will be updated
-- in a future step after the locations table is populated.
